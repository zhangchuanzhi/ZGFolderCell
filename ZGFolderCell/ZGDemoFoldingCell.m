...
@interface ZGDemoFoldingCell()
@property(nonatomic,strong)UIView*titleView;
@property(nonatomic,strong)UIView*titleView2;
@property(nonatomic,strong)UIView*infoView;
@end
@implementation ZGDemoFoldingCell
...
- (ZGRotatedView *)createForegroundView{
    ZGRotatedView * foregroundView = [[ZGRotatedView alloc] initWithFrame:CGRectZero];
